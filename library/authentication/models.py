...
class CustomUser(AbstractBaseUser):
    ...
    # Duplicate usernames are not allowed by Django, see:
    ...
    def get_role_name(self):
        ...
        # [django] ORM choices field get_field_display () display value
        # https://programmersought.com/article/21403495129/
